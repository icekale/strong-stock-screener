...
def test_auction_sample_window_covers_pre_open_period() -> None:
    ...
    assert is_auction_sample_window(datetime(2026, 7, 1, 9, 30, 30))
    assert not is_auction_sample_window(datetime(2026, 7, 1, 9, 30, 31))
